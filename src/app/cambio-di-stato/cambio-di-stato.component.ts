...
export class CambioDiStatoComponent implements OnInit {
  ...
  selectedRowChanged(e) {
    ...
    if ((this.sospensioneParams.codiceStatoCorrente === SOSPESO_CODICE) && this.lookupItems.length !== 1) {
  ...
  lookupValueChanged(e) {
    ...
    if ((e.value === "Passaggio di fase" || e.value === "Cambio di stato") && (this.sospensioneParams.codiceStatoCorrente === CHIUSO_CODICE || this.sospensioneParams.isFaseDiChiusura)) {
      notify({
